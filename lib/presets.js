/**
 * Model IDs checked 2026-08-28 against:
 ...
 *
 * grok-4.6 is on Go, Zen, and xAI. Go still lists grok-4.5.
 * glm-5.3 and qwen3.8-max are Go-only. Zen's newest GLM is still glm-5.2.
 * gpt-5.6-sol is Zen/OpenAI, not Go. Quality stays on Zen as a product choice.
 */
...
/** Substitute if Quality is forced onto the Go catalog. grok-4.6 is now on Go. */
